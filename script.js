...
// Check if the landingPage element is in view
const landingPage = document.querySelector('.landingPage');
const landingPageAnimationClass = 'animate__animated';

function addAnimationClassOnce() {
landingPage.classList.add(landingPageAnimationClass);
// Remove the event listener after adding the class
window.removeEventListener('scroll', addAnimationClassOnce);
}
// Add a scroll event listener to add the animation class when the page is scrolled
window.addEventListener('scroll', addAnimationClassOnce);
